...
class Student:
    ...
    # This part is image labels setting start 
        ...
        f_lb1.place(x=0,y=0,width=1366,height=130)
         ...
         # backgorund image 
        bg1=Image.open(r"C:\Users\jayan\Documents\Python_Test_Projects\Images_GUI\bg4.jpg")
        ...
        dep_combo["values"]=("Select Department","CSE","EEE","CIVIL","MECH","EE")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","BTECH","MTECH","DIPLOMA")
        cou_combo.current(0)
